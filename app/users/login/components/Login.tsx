 ...
 const ref = useRef(null)
  return (
    <form ref={ref} action={(formData)=>loginHandler(formData,ref)} className="min-h-screen w-full  flex justify-center pt-20 items-start ">
      <div className=" w-11/12 lg:w-2/5 p-6 bg-white flex flex-col justify-start items-start rounded gap-3 border">
        ...
        <div className="w-full flex flex-col justify-start items-start gap-3 ">
          <Button type="submit" text={"Sign In"} cssClass="w-full font-medium bg-black rounded text-fourth hover:bg-tertiary p-2 outline-none "/>
